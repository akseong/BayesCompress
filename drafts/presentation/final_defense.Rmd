...
- their goal: substantially reduce matrix size for edge computing
...
$$\scriptsize     \underset{\mathbf{X}}  {\begin{array}{ccccc}     \square \square \square \square \\     \square \square \square \square \\     \end{array}}     \times     \underset{\mathbf{W}} { \begin{array}{ccccc}     \square \square \square \square \square \square \square\\     \square \square \square \square \square \square \square\\     \square \square \square \square \square \square \square\\     \square \square \square \square \square \square \square\\     \end{array} }     + \mathbf{b}     = \underset{\mathbf{H}} {\begin{array}{ccccc}     \square \square \square \square \square \square \square\\     \square \square \square \square \square \square \square\\     \end{array}}$$
...
$$\scriptsize       \underset{\mathbf{X}}  {\begin{array}{ccccc}       \square \blacksquare \blacksquare \square \\      \square \blacksquare \blacksquare \square \\      \end{array}}      \times      \underset{\mathbf{W}} { \begin{array}{ccccc}       \square \square \square \square \square \square \square\\      \blacksquare \blacksquare \blacksquare \blacksquare \blacksquare \blacksquare      \blacksquare\\      \blacksquare \blacksquare \blacksquare \blacksquare \blacksquare \blacksquare      \blacksquare\\      \square \square \square \square \square \square \square\\      \end{array} }      + \mathbf{b}       = \underset{\mathbf{H}} {\begin{array}{ccccc}       \square \square \square \square \square \square \square\\      \square \square \square \square \square \square \square\\      \end{array}}$$
...
- eliminating rows in the next layer yields even more sparsity:



$$\scriptsize       \underset{\mathbf{X}}  {\begin{array}{ccccc}       \square \blacksquare \blacksquare \square \\      \square \blacksquare \blacksquare \square \\      \end{array}}      \times      \underset{\mathbf{W}} { \begin{array}{ccccc}       \square \square \square \blacksquare \square \blacksquare \square\\           \blacksquare \blacksquare \blacksquare \blacksquare \blacksquare \blacksquare      \blacksquare\\      \blacksquare \blacksquare \blacksquare \blacksquare \blacksquare \blacksquare      \blacksquare\\      \square \square \square \blacksquare \square \blacksquare \square\\     \end{array} }      + \mathbf{b}       = \underset{\mathbf{H}} {\begin{array}{ccccc}       \square \square \square \blacksquare \square \blacksquare \square\\      \square \square \square \blacksquare \square \blacksquare \square\\      \end{array}}$$
...
LUW 2017 use a log-uniform prior for $z$, corresponding to a continuous relaxation of the spike-and-slab.  
