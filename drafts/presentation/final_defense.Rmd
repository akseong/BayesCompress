...
We propose to model $f^\star(\mathbf{x}_i)$ using a feedforward neural network, denoted $f(\mathbf{x}_i, \{\mathbf{W}^{(\ell)}\}^L_{\ell=1})$, with $\ell$ layers each containing 
...
---
## reparameterization: Cauchy decomposition




---
## reparameterization: uncentered parameterization
