...
- precursors:
  ...
  - dropout (random 0 of weights) and variational dropout
...
$$\scriptsize    \underset{\mathbf{X}_{n \times p}}  {  \begin{array}{ccccc}         \square \square \square \square \\         \square \square \square \square \\       \end{array}}     \times   
...
$$\scriptsize     \underset{\mathbf{X}_{n \times p}}  {  \begin{array}{ccccc}         \square \square \square \square \\         \square \square \square \square \\       \end{array}}     \times     \underset{\mathbf{W}_{p \times d_1}} {   \begin{array}{ccccc}         \square \square \square \square \square \square \square\\         \square \square \square \square \square \square \square\\         \blacksquare \blacksquare \blacksquare \blacksquare \blacksquare \blacksquare \blacksquare\\         \square \square \square \square \square \square \square\\       \end{array} }     + \mathbf{b'_{d_1}}     = \underset{\mathbf{H}} {  \begin{array}{ccccc}         \square \square \square \square \square \square \square\\         \square \square \square \square \square \square \square\\     \end{array}}$$
...
$$\scriptsize     \underset{\mathbf{X}_{n \times p}}  {  \begin{array}{ccccc}         \square \square \blacksquare \square \\         \square \square \blacksquare \square \\       \end{array}}     \times     \underset{\mathbf{W}_{p \times d_1}} {   \begin{array}{ccccc}         \square \square \square \square \square \square \square\\         \square \square \square \square \square \square \square\\         \blacksquare \blacksquare \blacksquare \blacksquare \blacksquare \blacksquare \blacksquare\\         \square \square \square \square \square \square \square\\       \end{array} }     + \mathbf{b'_{d_1}}     = \underset{\mathbf{H}} {  \begin{array}{ccccc}         \square \square \square \square \square \square \square\\         \square \square \square \square \square \square \square\\     \end{array}}$$
...
\underset{\mathbf{W}_{p \times d_1}} { 
  \begin{array}{ccccc}     
    \square \square \square {\blacksquare} {\blacksquare} \square \square\\     
    \square \square \square {\blacksquare} {\blacksquare}  \square \square\\     
