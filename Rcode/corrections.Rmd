...
This seems like it is going to work.  I do suspect that there may have been training issues in some of these since I just trained all of these for a fixed number of epochs (admittedly v. large), and only 1 model on each dataset.  A common practice appears to be training several models on each dataset and using the one with the lowest training error; Rockova & Polson do this, for example).
