...
### using $\tau^{corr}$ in other simulations {.panelset}
...
- Also, it might make more sense to correct $\tau_1$ by the __square root__ of $\dfrac{d_1}{m_{eff}}$.



- sims 1:5 were trained for 1M epochs, 6:15 for 500K epochs.
