...
- $E_{q_\phi(z)} \left[\log \dfrac{1}{p(y|z)}$ is the expected surprise of the data under our model *when $z$ is sampled under $q_\phi(z)$*.
...
get_mses <- function(res, method_name = "Bnn"){
...
mse_tab <- get_mses(res, mathod_name = "SLP")
