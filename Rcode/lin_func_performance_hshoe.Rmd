...
alphas <- as_array(exp(slhs_net$fc1$get_log_dropout_rates()))
hskeep_05 <- alphas < .05
hskeep_50 <- alphas < .5
...
as_array(fcn_model$fc1$get_log_dropout_rates()$exp())
as_array(fcn_model$fc2$get_log_dropout_rates()$exp())
as_array(fcn_model$fc3$get_log_dropout_rates()$exp())
