...
save(contents, file = here::here("Rcode", "results", "hshoe_funcdata_n50k.Rdata"))
torch_save(fcn_model, path = here::here("Rcode", "results", "hshoe_funcdata_n50k.pt"))
...
curvmat <- cbind(
  c(xgrid, rep(0, 101*3)),
  c(rep(0, 101), xgrid, rep(0, 101*2)),
  c(rep(0, 101*2), xgrid, rep(0, 101)),
  c(rep(0, 101*3), xgrid)
)
mat0 <- matrix(0, nrow = 404, ncol = 100)
