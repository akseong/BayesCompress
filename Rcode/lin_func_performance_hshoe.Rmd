...
log_dropout(hslayer = slhs_net$fc1)
...
- $Var[X] = \left( \exp{\sigma^2_Y} - 1  \right) \exp{2 \mu_Y + \sigma^2_Y}$  

Then, for the dropout rate, we can use the variational parameters of the local shrinkage parameter $\tilde z$, where
