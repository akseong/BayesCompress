##################################################
## Project:   sparseVCBART sim - VC structure modeled, no vc layer
## Date:      March 3, 2026
## Author:    Arnie Seong
##################################################


# Only VC coefs modeled (i.e. BNN input is Z, output is coefs),
# - no explicit selection on xvars (i.e. no vc_hshoe layer)
