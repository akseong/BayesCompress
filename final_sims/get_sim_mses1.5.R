...
# MOD FCNS
# meanfssmallbias_5x16_origmodsupint_p100_mcor.5_5000obs_976304
# meanfssmallbias_5x16_origmodsupint_p100_mcor.5_2000obs_718268              
# meanfssmallbias_5x16_origmodsupint_p100_mcor.5_1000obs_21129
...
if (modfcns_TF){
  ...
  true_vec <- rep(0, 108)
  true_vec[1:8] <- 1
  fname_suffix <- "modfcns_mse2_mat"   
} else {
  reconstruct_fcn <- reconstruct_flistdat
  true_vec <- rep(0, 104)
  true_vec[1:4] <- 1
  fname_suffix <- "origfcns_mse2_mat"
}
...
for (s_i in 1:n_sims){
  ...
  x_scales <- scale_mat(as_array(simdat$x[1:n_ttsplit, ]))
  x_train <- x_scales$scaled
  
  x_test <- scale_mat(
    as_array(simdat$x[(1+n_ttsplit):sim_res$sim_params$n_obs, ]), 
    means = x_scales$means, 
    sds = x_scales$sds)$scaled

  y_train_raw <- as_array(simdat$y[1:n_ttsplit, ])
  ...
  # test_mse
  nn_mod$eval()
  yhat_test <- nn_mod(as_array(x_test))
  
  # unscaled
  yhat_test_unsc <- (yhat_test)*y_sd + y_mean
...
# ORIG
# "C:/Users/ArnoldSeong/Github/Classes/BayesCompress/final_sims/compiled/hshoe2det4_1k_50sims_origfcns_mse2_mat.Rdata"
# "C:/Users/ArnoldSeong/Github/Classes/BayesCompress/final_sims/compiled/hshoe2det4_2k_50sims_origfcns_mse2_mat.Rdata"
# "C:/Users/ArnoldSeong/Github/Classes/BayesCompress/final_sims/compiled/hshoe2det4_5k_50sims_origfcns_mse2_mat.Rdata"

# "C:/Users/ArnoldSeong/Github/Classes/BayesCompress/final_sims/compiled/hshoe4det1_1k_50sims_origfcns_mse2_mat.Rdata"
# "C:/Users/ArnoldSeong/Github/Classes/BayesCompress/final_sims/compiled/hshoe4det1_2k_50sims_origfcns_mse2_mat.Rdata"
# "C:/Users/ArnoldSeong/Github/Classes/BayesCompress/final_sims/compiled/hshoe4det1_5k_50sims_origfcns_mse2_mat.Rdata"

# MODFCNS
# "C:/Users/ArnoldSeong/Github/Classes/BayesCompress/final_sims/compiled/hshoe2det4_1k_50sims_modfcns_mse2_mat.Rdata"
# "C:/Users/ArnoldSeong/Github/Classes/BayesCompress/final_sims/compiled/hshoe2det4_2k_50sims_modfcns_mse2_mat.Rdata"
# "C:/Users/ArnoldSeong/Github/Classes/BayesCompress/final_sims/compiled/hshoe2det4_5k_50sims_modfcns_mse2_mat.Rdata"

# "C:/Users/ArnoldSeong/Github/Classes/BayesCompress/final_sims/compiled/hshoe4det1_1k_50sims_modfcns_mse2_mat.Rdata"
# "C:/Users/ArnoldSeong/Github/Classes/BayesCompress/final_sims/compiled/hshoe4det1_2k_50sims_modfcns_mse2_mat.Rdata"
# "C:/Users/ArnoldSeong/Github/Classes/BayesCompress/final_sims/compiled/hshoe4det1_5k_50sims_modfcns_mse2_mat.Rdata"



load("C:/Users/ArnoldSeong/Github/Classes/BayesCompress/final_sims/compiled/hshoe2det4_5k_50sims_modfcns_mse2_mat.Rdata"
)
mean(mse_mat[, 1])
sd(mse_mat[, 1])
# fMSE
