...
- The neurons that get 0'd out DON'T affect the $\lambda_j$'s when a coefficient should be 0.

- BUT when a coefficient should NOT be 0, the neurons that get 0'd out make the $\lambda_j$ SMALLER than it should be.

- SO WE SHOULD HAVE EVEN MORE SEPARATION in the local scale params.  This makes more sense to me.
