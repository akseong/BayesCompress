...
Also, maybe I shouldn't be standardizing the response?  Their data generation is really weird --- beta5 has huge values in it, which appear to make the response's range quite huge.    Probably also leading to more shrinkage.  __Take a look at Ghosh's code to see how they train/fit their models.__
