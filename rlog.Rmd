...
[code for sparseVCBART](https://github.com/ghoshstats/sparseVCBART):

- [`gen_data`](https://github.com/ghoshstats/sparseVCBART/blob/main/codes/common_sim.R)
...
- [visualizing VC mod testing](../VCmod/VC_first_sims_vis.html).  Vanilla modeling is OK, but not amazing.  Explicitly modeling VC structure is not working well; trying to figure out why (see 2/28 notes below)
